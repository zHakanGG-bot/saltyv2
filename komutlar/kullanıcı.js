...
exports.run = async (client, message, args) => {
  ...
  const Durum = user.presence.status;
			...
			const durm = (Durum == "online" ? (client.emojis.get('613716283065761812') + c) : (Durum == "offline" ? (client.emojis.get('613716282910441472') + cd) : (Durum == "idle" ? (client.emojis.get('516211156067680279') + b) : (Durum == "dnd" ? (client.emojis.get('613716282910441472') + r) : (dil.dont)))))
